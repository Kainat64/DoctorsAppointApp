...
const { consultationType } = route.params || {};
  ...
  (hospitalId) => {
    ...
    switch (consultationType) {
      case 'walk':
        ...
        break;
      case 'voice':
        screenName = "Book Voice Consultation";
        break;
      case 'video':
        screenName = "Video Consultation";
        break;
      default:
        screenName = "Book Appointment"; // Default case
    }
    navigation.navigate(screenName, { hospitalId });
  },
  [navigation, consultationType]
);
...
<TouchableOpacity
  ...
  onPress={() => ShowHospitalProfile(item.id)}
>
  <Ionicons
    name={
      consultationType === 'walk' ? 'walk-outline' :
      consultationType === 'voice' ? 'mic' :
      'videocam' // Video icon
    }
    size={16}
    color="white"
  ...
  <Text style={styles.buttonText}>
    {consultationType === 'walk' ? 'Walk in Consultation' :
     consultationType === 'voice' ? 'Voice Consultation' :
     'Video Consultation'}
  </Text>
</TouchableOpacity>

...
import { ScrollView, Text, StyleSheet, View, Image, Linking,TouchableOpacity,Modal, Pressable } from "react-native";
...
const DoctorProfileDetails = ({route}) => {
  ...
  useEffect(() => {
    const fetchDoctors = async () => {
      try {
        const response = await fetch(`https://doctors-365.caesar.business/api/doctors/${doctorId}`);
        if (!response.ok) {
      ...
      <View style={styles.card}>
          <View style={styles.row}>
              <View style={styles.doctorProfileDetails}>
                  <View style={[styles.doctorProfileDetailsInner, styles.wrapperPosition]}>
                      <View style={[styles.groupParent, styles.groupParentFlexBox]}>
                          ...
                          <View style={styles.frameView}>
                              <View style={[styles.drLauraParent, styles.groupParentFlexBox]}>
                                  <Text style={[styles.drLaura1, styles.lauraTypo]}>{doctor.first_name} {doctor.last_name}</Text>
                                  <Image
                              ...
                              <Text style={[styles.specialistDentist, styles.specialistClr]}>
                              ...
                              >
                                  <Text style={[styles.bdsFcpsOrthodontics, styles.specialistClr]}>
                  ...
                  <View style={[styles.frameParent1, styles.wrapperPosition, styles.row]}>
                      ...
                      <View style={styles.frameWrapper1}>
                          <View style={styles.parent}>
                              <Text style={[styles.text, styles.textTypo]}>{doctor.experience}</Text>
                  ...
                  <View
                      style={[styles.doctorProfileDetailsChild, styles.frameParentPosition]}
                  >
                      <View style={[styles.frameParent2, styles.groupParentFlexBox]}>
                      <View style={[styles.frameParent2, styles.groupParentFlexBox]}>
                      <Pressable onPress={() => navigation.navigate('Video Consultation')}>
                      <View style={[styles.frameWrapper3, styles.frameWrapperLayout]}>
                                    <View style={styles.groupParentFlexBox}>
                                        ...
                                        />
                                        <Text style={[styles.videoConsultaion, styles.btnbooking]}>
                                            Video Consultaion
                                        </Text>
                                    </View>
                                </View>
                                ...
                                <Pressable onPress={() => ShowBookAppointment(doctor.id)}>
                  ...
                  <View
                      style={[styles.loremIpsumDolorSitAmetConWrapper, styles.iconPosition]}
                  >
                ...
                <View style={styles.row}>
                    <View style={styles.doctorProfileDetails}>
                        ...
                        <View style={styles.card1}>
                            <View style={styles.row}>
                                <Text style={{fontSize:32, fontWeight:600, color:'blue', marginLeft:130}}>132</Text>
                            </View>
                            <View style={[styles.row, styles.revHeading]}>
                            <Text style={{fontSize:22,color:'green',fontWeight:'600'}}>Positive Patient Reviews</Text>
                  ...
                  >
                    ...
                    />
                            ...
                            <View style={[styles.row, styles.revHeading]}>
                            <Text style={{fontSize:22,fontWeight:'600', marginTop:50}}>500 + Daily Visitors</Text>

                            </View>
                        </View>
                        <View style={styles.card3}>
                            <View style={styles.frameParent7}>
                                <View style={[styles.frameWrapper5, styles.frameWrapperShadowBox]}>
                                    <View style={styles.frameParent3}>
                                        <View style={[styles.frameParent9, styles.frameParentFlexBox]}>
                                            <View style={styles.frameParentFlexBox1}>
                                                ...
                                                <View style={styles.frameParent10}>
                                                    <View
                                                        style={[
                                                            styles.johnSmithParent,
                                                            styles.frameParentFlexBox1,
                                                        ]}
                                                    >
                                                        <Text style={[styles.johnSmith, styles.daysAgoTypo1]}>
                                                            John Smith
                                                        </Text>
                                                        <Image
                                                            style={[
                                                                styles.check160199581Icon1,
                                                                styles.check160199581IconLayout,
                                                            ]}
                                                            resizeMode="cover"
                                                            source={require("../assets/check-16019958-1.png")}
                                                        />
                                                    </View>
                                                    <Text style={[styles.daysAgo, styles.daysAgoTypo]}>
                                                        15 days Ago
                                                    </Text>
                                                </View>
                                            </View>
                                            <View style={styles.frameWrapper6}>
                                                <View style={styles.frameParentFlexBox1}>
                                                    ...
                                                    />
                                                    <Text
                                                        style={[styles.videoConsultations, styles.reviewsTypo]}
                                                    >
                                                        Video Consultations
                                                    </Text>
                                                </View>
                                        ...
                                        <View style={styles.frameParent12}>
                                            <View style={styles.frameParent33}>
                                                <Text style={[styles.patientFeedback, styles.daysAgoTypo1]}>
                                                    Patient Feedback:
                                                </Text>
                                                <Text style={[styles.loremIpsumDolor, styles.daysAgoTypo]}>
                                                    Lorem ipsum dolor sit amet consectetur. Aliquam nibh
                                                    auctor pretium id. Ut arcu varius hac sit. Aenean ac
                                                    curabitur enim blandit facilisis quisque.
                                                </Text>
                                            </View>
                                            <View style={styles.frameWrapperSpaceBlock}>
                                                <View style={styles.frameParentFlexBox1}>
                                                    <View style={styles.wrapperBorder}>
                                                        <Text style={[styles.satisfied, styles.daysAgoTypo1]}>
                                                            Satisfied
                                                        </Text>
                                                    </View>
                                                    <View
                                                        style={[
                                                            styles.noWaitingTimeWrapper,
                        ...
                        <View style={styles.doctorProfileDetails}>
                            ...
                            <View style={styles.card1}>
                                ...
                                >
                                    ...
                                    <View
                                        style={[styles.rs1000Wrapper, styles.parentWrapperFlexBox]}
                                    >
                                ...
                                >
                                    <View style={styles.componentLayout}>
                                        <View
                                            style={[styles.monWrapper, styles.wrapperFlexBox]}
                                        >

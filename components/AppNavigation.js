...
import OnlinePrescription from '../Screens/OnlinePrescription/OnlinePrescription';
import RegisterOtpVerificationScreen from '../Screens/Login&Register/RegisterOtpVerification';
...
const AuthNavigator = () => (
  <AuthStack.Navigator>
    ...
    />
      ...
      component={RegisterOtpVerificationScreen}
      options={{headerShown: false}}
    />
  </AuthStack.Navigator>
);
